...
namespace Xanthos.ShrinkSystem
{
    public class ShrinkCommands
    {
        ...
        static private void SetLockDown(bool lockDown )
        {
    ...
    public class ShrinkTarget : Target
    {
        ...
        protected override void OnTarget( Mobile from, object target )
        {
            ...
            else if ( ( pet.Body == 400 || pet.Body == 401 ) && pet.Controlled == false )
                from.SendMessage( "That person gives you a dirty look!" );
            ...
            else
            {
                if (pet.ControlMaster != from && !pet.Controlled)
                {
                    ...
                    {
                        pet.Spawner.Remove(pet);  // Ensure the correct parameter is passed to Remove
                        pet.Spawner = null;
                    }
